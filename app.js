...
for (const searchToggler of searchTogglers) {
...
searchField.addEventListener("input", () => {
    ...
    if (!searchField.value) {
        ...
        searchField.classList.add("is-searching");
    }
        ...
        searchTimeOut = setTimeout(() => {
            fetchData(url.geo(searchField.value), (locations) => {
                ...
                for (const { name, lat, lon, country, state } of locations) {
                    ...
                    searchedItem.classList.add("view__item");

                    searchedItem.innerHTML = `
                        <svg class="location-icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 512 512" style="fill: var(--white);">
                        ...
                        <div>
                            ...
                            <p class="item__subtitle label-2">${state || ""}, ${country}</p>
                        </div>

                        <a class="item__link has-state search-toggler" href="#/weather?lat=${lat}&lon=${lon}" aria-label="${name} weather"></a>
                    `;

                    searchResult.querySelector(".view__list").appendChild(searchedItem);
                    items.push(searchedItem.querySelector(".search-toggler"));
                }
...
export function updateWeather(lat, lon) {
    ...
    const hourlyForecastSection = document.querySelector(".hourly__forecast");
    const fiveDayForecastSection = document.querySelector(".five__day__forecast");
    ...
    fetchData(url.currentWeather(lat, lon), (currentWeather) => {
        ...
        card.innerHTML = `   
            ...
            <div class="wrapper">
                ...
                <img class="weather__icon" src="./images/weather_icons/${icon}.png" width="64" height="64" alt="${description}">
            </div>
            ...
            <ul class="meta-list">
                <li class="meta-item">
                    <svg class="calendar-icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 512 512">
            ...
            card.innerHTML = `
                ...
                <div class="highlight-list">
                    <div class="card card-sm highlight-card one">
                        ...
                        <div class="wrapper">
                            <svg class="wind__icon" width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="card card-sm highlight-card two">
                        ...
                        <div class="card-list">
                            <div class="card-item">
                                <svg class="svg__sunny" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 512 512">
                            ...
                            <div class="card-item">
                                <svg class="svg__moon" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 512 512">
                    ...
                    <div class="card card-sm highlight-card">
                        ...
                        <div class="wrapper">
                            <svg class="svg__water" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 512 512">
                            ...
                            <p class="title-2">${humidity}<sub>%</sub></p>
                        </div>
                    </div>
                    ...
                    <div class="card card-sm highlight-card">
                        ...
                        <div class="wrapper">
                            <svg class="svg__air" fill="#000000" width="32" height="32" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <p class="title-2">${pressure}<sub>hPa</sub></p>
                        </div>                          
                    </div>
                    ...
                    <div class="card card-sm highlight-card">
                        ...
                        <div class="wrapper">
                            <svg class="svg__eye" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 512 512">
                    ...
                    <div class="card card-sm highlight-card">
                        ...
                        <div class="wrapper">
                            <svg class="svg__thermostat" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" viewBox="0 0 50 50" enable-background="new 0 0 50 50" xml:space="preserve" width="32" height="32">
                            ...
                            <p class="title-2">${parseInt(feels_like)}&deg;<sub>c</sub></p>
                        </div>                                
                    </div>
                </div>
            `;
        ...
        fetchData(url.forecast(lat, lon), (forecast) => {
            ...
            for (const [index, data] of forecastList.entries()) {
                ...
                const tempLi = document.querySelector("li");
                tempLi.classList.add("slider__item");

                tempLi.innerHTML = `
                    <div class="slider__card card card-sm">
                        <p class="body-3">${module.getHour(dateTimeUnix, timezone)}</p>

                        <img class="weather__icon" src="./images/weather_icons/${icon}.png" alt="${description}" width="48" height="48" loading="lazy" title="${description}">

                        <p class="body">${parseInt(temp)}&deg;</p>
                    </div>
                `;
                ...
                windLi.innerHTML = `
                    <div class="slider__card card card-sm">
                        <p class="body-3">${module.getHour(dateTimeUnix, timezone)}</p>
                        <img class="weather__icon" src="./images/weather_icons/direction.png" alt="" width="48" height="48" loading="lazy" title="" style="transform: rotate(${windDirection - 180}deg);">
                        <p class="body">${parseInt(module.mpsToKmh(windSpeed))} km/h</p>
                    </div>
                `;
            ...
            */
            fiveDayForecastSection.innerHTML = `
                ...
                <div class="forecast__card card card-lg">
            ...
            for (let i = 7; i < forecastList.length; i += 8) {
                ...
                li.innerHTML = `
                    <div class="icon__wrapper">
                        <img class="weather__icon" src="./images/weather_icons/${icon}.png" alt="${description}" width="36" height="36" title="${description}">
                        <span class="span">
                ...
                fiveDayForecastSection.querySelector("[data-forecast-list]").appendChild(li);
            }
